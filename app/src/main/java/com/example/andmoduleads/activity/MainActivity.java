...
import com.ads.control.ads.nativeAds.RKNativeAdView;
import com.ads.control.config.RKAdConfig;
import com.ads.control.ads.bannerAds.BannerAdView;
...
public class MainActivity extends AppCompatActivity {
    ...
    private RKNativeAdView rkNativeAdView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        rkNativeAdView = findViewById(R.id.itgNativeAds);


        configMediationProvider();
        RKAd.getInstance().setCountClickToShowAds(3);
         ...
         */
        rkNativeAdView.loadNativeAd(this, idNative, new RKAdCallback() {
            @Override
        ...
        BannerAdView bannerAdView = findViewById(R.id.bannerView);
        bannerAdView.loadBanner(this, idBanner, new RKAdCallback() {
            @Override
            public void onAdImpression() {
                super.onAdImpression();
            }
        ...
        findViewById(R.id.btShowAds).setOnClickListener(v -> {
            if (mInterstitialAd.isReady()) {
                ...
                ApInterstitialAd inter = RKAd.getInstance().getInterstitialAds(this, idInter, null);

                RKAd.getInstance().showInterstitialAdByTimes(this, mInterstitialAd, new RKAdCallback() {
                    @Override
        ...
        findViewById(R.id.btnShowReward).setOnClickListener(v -> {
            ...
            rewardAd = RKAd.getInstance().getRewardAd(this,  BuildConfig.ad_reward, null);
        });
    ...
    private void loadAdInterstitial() {
        ...
        mInterstitialAd = RKAd.getInstance().getInterstitialAds(this, idInter, null);
    }


    public void onTrackSimpleEventClick(View v) {
        RKAdjust.onTrackEvent(EVENT_TOKEN_SIMPLE);
    }

    public void onTrackRevenueEventClick(View v) {
        RKAdjust.onTrackRevenue(EVENT_TOKEN_REVENUE, 1f, "EUR");
    }
