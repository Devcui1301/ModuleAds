...
//                setupAdAdapter();
    ...
    private void setupAdAdapter() {
        adAdapter = RKAd.getInstance().getNativeRepeatAdapter(this, idNative, layoutCustomNative, com.ads.control.R.layout.layout_native_medium,
