...
public class RKAdPlacer {
    ...
    public void renderAd(int pos, RecyclerView.ViewHolder holder) {
        ...
        assert adNative != null;
        if (adNative.getAdmobNativeAd() == null) {
            if (Objects.requireNonNull(listAd.get(pos)).getStatus() != StatusAd.AD_LOADING) {
                holder.itemView.post(() -> {
                    ...
                    Admob.getInstance().loadNativeAd(activity, settings.getAdUnitId(), new AdCallback() {
                        ...
                        public void onUnifiedNativeAdLoaded(@NonNull NativeAd unifiedNativeAd) {
                            ...
                            unifiedNativeAd.setOnPaidEventListener(new OnPaidEventListener() {
                                ...
                                public void onPaidEvent(@NonNull AdValue adValue) {
                                    RKAdPlacer.this.onAdRevenuePaid(new ApAdValue(adValue));
                                }
                            });

                            RKAdPlacer.this.onAdLoaded(pos);
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            RKAdPlacer.this.onAdClicked();
                        }

                        @Override
                        public void onAdImpression() {
                            super.onAdImpression();
                            RKAdPlacer.this.onAdImpression();
                        }
                    }, null);
                });
            }
