...
import com.ads.control.ads.nativeAds.AdPlacerSettings;
...
public class Admob {
    private static final String TAG = "RKAdmob";
...
//            return;
    ...
    public void onShowSplash(AppCompatActivity activity, AdCallback adListener, String tokenAdjust) {
        ...
        mInterstitialSplash.setOnPaidEventListener(adValue -> {
            ...
            RKLogEventManager.logPaidAdImpression(context,
                    adValue,
            ...
            if (tokenAdjust != null) {
                RKLogEventManager.logPaidAdjustWithToken(adValue, mInterstitialSplash.getAdUnitId(), tokenAdjust);
            }
        });
        ...
        mInterstitialSplash.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                RKLogEventManager.logClickAdsEvent(context, mInterstitialSplash.getAdUnitId());
            }
            ...
            public void onInterstitialLoad(InterstitialAd interstitialAd) {
                ...
                if (interstitialAd != null) {
                    interstitialAd.setOnPaidEventListener(adValue -> {
                        ...
                        if (tokenAdjust != null) {
                            RKLogEventManager.logPaidAdjustWithToken(adValue, interstitialAd.getAdUnitId(), tokenAdjust);
                        }
                    });
                }
            }
    ...
    public void showInterstitialAdByTimes(final Context context, InterstitialAd mInterstitialAd, final AdCallback callback) {
        ...
        mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                RKLogEventManager.logClickAdsEvent(context, mInterstitialAd.getAdUnitId());
            }
        });
        ...
        try {
            ...
            adView.setAdListener(new AdListener() {
                ...
                public void onAdLoaded() {
                    ...
                    if (adView != null) {
                        adView.setOnPaidEventListener(adValue -> {
                            ...
                            if (tokenAdjust != null) {
                                RKLogEventManager.logPaidAdjustWithToken(adValue, adView.getAdUnitId(), tokenAdjust);
                            }
                        });
                    }
                ...
                public void onAdClicked() {
                    ...
                    RKLogEventManager.logClickAdsEvent(context, id);
                }
                ...
                .forNativeAd(new NativeAd.OnNativeAdLoadedListener() {
                    ...
                    public void onNativeAdLoaded(@NonNull NativeAd nativeAd) {
                        ...
                        nativeAd.setOnPaidEventListener(adValue -> {
                            ...
                            if (tokenAdjust != null) {
                                RKLogEventManager.logPaidAdjustWithToken(adValue, id, tokenAdjust);
                            }
                        });
                    }
                })
    ...
    public void loadNativeAdsFullScreen(Context context, String id, final AdCallback callback, String tokenAdjust) {
        if (Arrays.asList(context.getResources().getStringArray(R.array.list_id_test)).contains(id)) {
            showTestIdAlert(context, NATIVE_ADS, id);
        }
        if (AppPurchase.getInstance().isPurchased(context)) {
        ...
        LinkedBlockingQueue<NativeAd> nativeAdsPool = new LinkedBlockingQueue<>();
...
//
        ...
        RewardedAd.load(context, id, getAdRequest(), new RewardedAdLoadCallback() {
            ...
            public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
                ...
                Admob.this.rewardedAd.setOnPaidEventListener(adValue -> {
                    ...
                    if (tokenAdjust != null) {
                        RKLogEventManager.logPaidAdjustWithToken(adValue, rewardedAd.getAdUnitId(), tokenAdjust);
                    }
                });
            }
        ...
        if (rewardedAd == null) {
            ...
            Admob.this.rewardedAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                ...
                public void onAdClicked() {
                    ...
                    if (disableAdResumeWhenClickAds)
                        AppOpenManager.getInstance().disableAdResumeByClickAction();
                    RKLogEventManager.logClickAdsEvent(context, rewardedAd.getAdUnitId());
                }
            });
    ...
    public void showRewardInterstitial(final Activity activity, RewardedInterstitialAd rewardedInterstitialAd, final RewardCallback adCallback, String tokenAdjust) {
        ...
        if (rewardedInterstitialAd == null) {
            ...
            rewardedInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                ...
                public void onAdClicked() {
                    super.onAdClicked();
                    RKLogEventManager.logClickAdsEvent(activity, rewardedAd.getAdUnitId());
                    if (disableAdResumeWhenClickAds)
                        AppOpenManager.getInstance().disableAdResumeByClickAction();
                }
            });
    ...
    public AdmobRecyclerAdapter getNativeRepeatAdapter(Activity activity, String id, int layoutCustomNative, int layoutAdPlaceHolder, RecyclerView.Adapter originalAdapter,
        ...
        AdPlacerSettings settings = new AdPlacerSettings(layoutCustomNative, layoutAdPlaceHolder);
