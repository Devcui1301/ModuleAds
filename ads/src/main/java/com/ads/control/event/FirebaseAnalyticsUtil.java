...
*/
    ...
    static void logPaidAdImpressionValue(Context context, Bundle bundle, int mediationProvider) {
        if (mediationProvider == RKAdConfig.PROVIDER_MAX)
    ...
    static void logEventAdsImpressionRocket(Context context, Bundle bundle, int mediationProvider) {
        FirebaseAnalytics.getInstance(context).logEvent("ad_impression_rocket", bundle);
    }
